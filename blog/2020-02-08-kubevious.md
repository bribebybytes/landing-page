...
![cover](../static/screenshots/kubevious/kubevious-cover.jpg)
...
[![cover](../static/screenshots/kubevious/kubeviousvideo.png)](https://www.youtube.com/watch?v=E3giPRiXSVI)
...
- Capacity planning and list goes on.
 ...
 Stay till the end of this article, I am going to explain starting from setup and going to end it with where it can help you in your day to day activities, and dont forget to share this with your friends and colleages.
...
![landingpage](../static/screenshots/kubevious/kubevious-landingpage.png)
...
Lets say i want to looks for resources using port 8080 and then I can filter the resource that I am interested in, say for example I am selecting service. 
![search](../static/screenshots/kubevious/search.png)
Now you can see it shows two resources one from ArgoCD and other from kube-system.
...
![hierarchy](../static/screenshots/kubevious/heirarchy.png)
...
![impact radius](../static/screenshots/kubevious/impact_radius.png)
...
![editport](../static/screenshots/kubevious/editport.png)
...
![missingport](../static/screenshots/kubevious/missingport.png)
It is not just that, the main functionality is here in this timeline tab. You will have to activate timemachine by clicking here. 
![timemachine](../static/screenshots/kubevious/timemachine.png)
Now you have the ability to go back in time and see what config was present at that time. By going back in the timeline you can see port was 8082 before I chnaged it and there is no warning at that time. So I can take action rightaway to fix my changes. 
...
![markers](../static/screenshots/kubevious/markers.png)
...
![rule-editor](../static/screenshots/kubevious/ruleeditor1.png)
...
![rule-editor](../static/screenshots/kubevious/ruleeditor2.png)
...
Kubevious simplifies both, you can quickly check resource configuration in properties window here.

![resourceusage](../static/screenshots/kubevious/resourceusage.png)

 And over priviledged resoures are marked with markers I explained in last section.


### RBAC linked views
Role based access control important and complex concept in kubernetes, I am going to comeup with a detailed video on RBAC in my channel [BribeByBytes](https://youtube.com/c/BribeByBytes?sub_confirmation=1), do hit that subscribe button, if you would like to watch one.
If you look at RBAC directly on yaml file it might become pretty complex to follow. 

![yaml-text](../static/screenshots/kubevious/yaml_text.png)

Kubevious simplifies it by showing easy to read matrix. If I again take you to argocd-application-controller and expand "resource role matrix" in properties window, you can see a neat representation, have you ever seen any other GUI does this. I havent, if you have add that to the comments would like to hear from you.
...
## Kubevious portable
I know when I started this article I mentioned install Kubevious into the cluster to unveal its full power. But if you just want to give it a try you can try using [kubevious portable version](https://github.com/kubevious/kubevious#running-kubevious-outside-the-cluster) that runs on your local machine but with limited functionality like for e.g., time machine is not there etc.

Now that we have come to end of this article, you can check my videos on other GUI/IDEs like [K9S](https://www.youtube.com/watch?v=1EaVrpMvLH0) and [Kubernetes Lens IDE](https://www.youtube.com/watch?v=namZg1UC7wc). And dont miss by full free playlist on [Kubernetes simplified](https://www.youtube.com/watch?v=1Xt-0_wsFnM&list=PL-dDmq4YllM9w7i2Mn8vGXisCul1OTltu) and hit that subscribe button.
